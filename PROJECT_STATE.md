...
tests/
  ...
  api/
    ...
    test_posts.py      # 4 API scenarios (5 test functions)
requirements.txt
pytest.ini
README.md
...
- **4 API scenarios** — list + schema, GET by id (200/404), POST 201 + echo, PUT + DELETE (no persistence check)
...
- **Local verification** — 9 tests passing (4 UI + 5 API) on Windows with `.venv`
